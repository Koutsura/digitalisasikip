                        ...
                        <tbody>
                            @foreach ($program_studi as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->akreditasi_prodi }}</td>
                                    <td>{{ $item->ukt_spp }}</td>

                                    <td>
                                        <a href="{{ route('program_studi.edit', $item->kode_prodi) }}" class="btn btn-primary">Edit</a>
                                        <form action="{{ route('program_studi.delete', $item->kode_prodi) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
